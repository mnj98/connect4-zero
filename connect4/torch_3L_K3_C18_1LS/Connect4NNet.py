...
class Connect4NNet(nn.Module):
    def __init__(self, game, args):
        ...
        self.status_layer = nn.Linear(self.board_x * self.board_y  * 18, self.board_x * self.board_y) #should interpret threat/score map and provide a signal about the current state of the game
