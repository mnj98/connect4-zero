...
class Connect4NNet(nn.Module):
    def __init__(self, game, args):
        ...
        # 3x3x3 = 27 output layers, goal is for each layer to learn a single spot on the 3x3 for player/opponent/empty
        ...
        self.status_layer = nn.Linear(self.board_x * self.board_y * 27, self.board_x * self.board_y * 3) #should interpret threat/score map and provide a signal about the current state of the game
        self.valuation_layer = nn.Linear(self.board_x * self.board_y * 3, self.board_x * self.board_y)
        ...
        self.status_layer_bn = nn.BatchNorm1d(self.board_x * self.board_y * 3)
